        ...
        <div style={{ padding: '2rem', color: 'white' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
                <div style={{ background: 'rgba(255,255,255,0.05)', padding: '1.5rem', borderRadius: '1rem', textAlign: 'center' }}>
                    <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginBottom: '0.5rem' }}>Total Activos</p>
                    <h2 style={{ fontSize: '2rem', fontWeight: 'bold' }}>{activePacientes.length}</h2>
                </div>
                <div style={{ background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.2)', padding: '1.5rem', borderRadius: '1rem', textAlign: 'center' }}>
                    <p style={{ color: '#10b981', fontSize: '0.9rem', marginBottom: '0.5rem' }}>Riesgo Bajo</p>
                    <h2 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#10b981' }}>{nLow}</h2>
                </div>
                <div style={{ background: 'rgba(245,158,11,0.1)', border: '1px solid rgba(245,158,11,0.2)', padding: '1.5rem', borderRadius: '1rem', textAlign: 'center' }}>
                    <p style={{ color: '#f59e0b', fontSize: '0.9rem', marginBottom: '0.5rem' }}>Riesgo Medio</p>
                    <h2 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#f59e0b' }}>{nMedium}</h2>
                </div>
                <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', padding: '1.5rem', borderRadius: '1rem', textAlign: 'center' }}>
                    <p style={{ color: '#ef4444', fontSize: '0.9rem', marginBottom: '0.5rem' }}>Riesgo Alto</p>
                    <h2 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#ef4444' }}>{nHigh}</h2>
                </div>
            </div>
